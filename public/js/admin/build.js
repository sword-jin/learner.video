...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Siderbar = __webpack_require__(4);
	...
	var _Series = __webpack_require__(20);

	var _Series2 = _interopRequireDefault(_Series);

	var _Videos = __webpack_require__(27);

	var _Videos2 = _interopRequireDefault(_Videos);

	var _Subscribers = __webpack_require__(30);
	...
	Vue.use(__webpack_require__(35));
	Vue.use(VueRouter);
	...
	Vue.filter('timeForHuman', function (value) {
	    if (value < 60) {
	        return value + '秒';
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/home/rry/code/RryLee/Learner/resources/assets/js/admin/components/Header.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/rry/code/RryLee/Learner/resources/assets/js/admin/components/Siderbar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/rry/code/RryLee/Learner/resources/assets/js/admin/views/DashBoard.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/rry/code/RryLee/Learner/resources/assets/js/admin/views/Users.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-54b05336&file=Users.vue!./../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Users.vue", function() {
				var newContent = require("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-54b05336&file=Users.vue!./../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Users.vue");
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    computed: {
	        removeAble: function removeAble() {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        editSeries: function editSeries(serie) {
	            this.editing = true;
	            this.setSeriesForm(serie.id, serie.title, serie.slug, serie.description, serie.image, serie.created_at, serie.updated_at, serie.videos);
	        ...
	        setSeriesForm: function setSeriesForm(id, title, slug, description, image, created_at, updated_at, videos) {
	            this.newSerie = { id: id, title: title, slug: slug, description: description, image: image, created_at: created_at, updated_at: updated_at, videos: videos };
	        },
...
/***/ function(module, exports) {
	...
	module.exports = {
	    data: function data() {
	        return {
	            columns: ['ID', '标题', '系列', '来源', '长度', '上传时间', '发布时间'],
	            newVideo: {
	                id: '',
	                series_id: '',
	                title: '',
	    ...
	    methods: {
	        ...
	        saveVideo: function saveVideo() {
	            ...
	            if (this.editing) {
	                this.$http.put('/admin/videos/' + this.newVideo.id, this.getFormData()).then(function (response) {
	                    jQuery('#saveVideoModal').modal('hide');

	                    _this.updateVideoList(response.data.video);
	                ...
	                this.$http.post('/admin/videos', this.getFormData()).then(function (response) {
	                    ...
	                    _this.videos.unshift(response.data.video);
	        ...
	        editVideo: function editVideo(video) {
	            ...
	            this.setVideoForm(video.id, video.series_id, video.title, video.image, video.duration, video.description, video.resource_type, video.resource_id, video.published_at, video.created_at, video.updated_at);
	        ...
	        deleteVideo: function deleteVideo(id) {
	            ...
	            self.$http.delete('/admin/videos/' + id).then(function (response) {
	                if (response.status == 202) {
	                    ...
	                    _this2.removeVideo(id);
	                }
	            });
	        },
	        updateVideoList: function updateVideoList(video) {
	            var index = this.findIndexById(video.id);

	            this.videos.$set(index, video);
	        },
	        findIndexById: function findIndexById(id) {
	            var ids = this.videos.map(function (v) {
	                return v.id;
	            });
	        ...
	        setVideoForm: function setVideoForm(id, series_id, title, image, duration, description, resource_type, resource_id, published_at, created_at, updated_at) {
	            this.newVideo = { id: id, series_id: series_id, title: title, image: image, duration: duration, description: description, resource_type: resource_type,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function install(Vue) {
	    ...
	    Vue.url = __webpack_require__(37);
	    Vue.http = __webpack_require__(43);
	    Vue.resource = __webpack_require__(58);
	    Vue.Promise = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlTemplate = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var interceptor = __webpack_require__(48);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(36);
	var Promise = __webpack_require__(45);
	var xhrClient = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jsonpClient = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(36);
	var xdrClient = __webpack_require__(57);
